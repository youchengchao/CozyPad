...
class _TerminalScrollGestureHandlerState
  ...
  /// Whether the scroll events should be intercepted.
  var _shouldInterceptScroll = false;

  bool get shouldInterceptScroll =>
  ...
  void initState() {
    ...
    final nextShouldIntercept = shouldInterceptScroll;
    if (_shouldInterceptScroll != nextShouldIntercept) {
      _shouldInterceptScroll = nextShouldIntercept;
      if (_shouldInterceptScroll) {
        lastLineOffset = 0;
      }
    }
    super.initState();
  ...
  void _onScroll(double offset) {
    ...
    if (lineHeight <= 0.1 || lineHeight.isNaN || lineHeight.isInfinite) {
      return;
    }
